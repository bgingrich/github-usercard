/* Step 1: using axios, send a GET request to the following URL 
           ...
           https://api.github.com/users/bgingrich
*/
axios.get('https://api.github.com/users/bgingrich')
    .then(response => {
        console.log(response);
        const myInfo = response.data;
        GitHubCards(response.data);
        const mainCard = document.querySelector('.cards');
        const cardInfo = GitHubCards(myInfo);
        console.log(myInfo);
...
const followersArray = ['RobertElias', 'ajmerr13', 'jor_poon', 'EricFerguson76', 'leachcoding'];
i = 0;
